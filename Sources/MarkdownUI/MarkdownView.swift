...
public struct MarkdownView: View {
    ...
    ///   - spacing: The distance between adjacent blocks, or `nil` if you
    ///              want the view to choose a default distance for each
    ///              pair of subviews.
    public init(_ markdown: String, spacing: CGFloat? = nil) {
    ...
    ///              subviews.
    ///   - markdown: Callback for the Markdown content to display.
    public init(spacing: CGFloat? = nil, markdown: () -> String) {
        document = Document(parsing: markdown())
        self.spacing = spacing
    }
